...
class Simulator:
    ...
    def __init__(self, params, initial_state):
        ...
        self.u = np.matrix(np.array([0,0,0,-self.gravity * self.time_step])).T
...
class KalmanFilter:
    ...
    def __init__(self, params, size_state, size_control, size_observations, simulator, evolution_noise, observation_noise):
        ...
        self.uk =  np.matrix(np.array([0,0,0,-self.gravity * self.time_step])).T
...
if __name__ == '__main__':
    ...
    plt.savefig('kalman-ex1.png',dpi=150, bbox_inches='tight')
